...
namespace DkaizaProject.Migrations
{
    ...
    [Migration("20260610060352_SyncModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DkaizaProject.Models.Calificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DkaizaProject.Models.Cupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EsPorcentaje = true,
                            FechaExpiracion = new DateTime(2026, 12, 31, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            MontoDescuento = 0m,
            ...
            modelBuilder.Entity("DkaizaProject.Models.NotaCliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("NotasCliente");
                });

            modelBuilder.Entity("DkaizaProject.Models.Notificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DkaizaProject.Models.Calificacion", b =>
                {
                    b.HasOne("DkaizaProject.Models.Cita", "Cita")
                        .WithOne()
                        .HasForeignKey("DkaizaProject.Models.Calificacion", "CitaId")
