    ...
    public class AppointmentsController : Controller
{
    ...
    // GET /Appointments/Reservar
    public async Task<IActionResult> Reservar()
    {
        if (CurrentClienteId == null)
            return RedirectToAction("Login", "Account", new { returnUrl = "/Appointments/Reservar" });
    ...
    // GET /Appointments/EstilistasDisponibles?servicioId=1&fecha=2024-05-10
    [HttpGet]
    ...
    // GET /Appointments/HorariosDisponibles?servicioId=1&estilistaId=1&fecha=2024-05-10
    [HttpGet]
    ...
    {
        if (CurrentClienteId == null)
            return Json(new { success = false, message = "Debes iniciar sesión para reservar." });
